...
\date{\today}
\author{Vikas Dhiman\\ David Johnson\\ Madan Raviganesh\\ Jason J Corso}
...
\begin{frame}{Modern cameras}
  \hl{Should refrain from having bullet examples. Find some non-violent examples.}
...
\begin{frame}{Step 1}
  \hl{Put a picture of cup without tape}
  \begin{columns}
...
\begin{frame}{Step 3}
  \hl{Put a picture of cup without push pin}
  \begin{columns}
    \begin{column}{0.6\textwidth}
...
\begin{frame}{Step 4}
  \hl{Put a picture of cup without push pin but with a hole}
  \begin{columns}
    \begin{column}{0.6\textwidth}
...
\begin{frame}{Using the pinhole camera}
  \hl{Show a picture of how to use the camera}
  \begin{itemize}
    \item
...
\begin{frame}{Effect of changing screen-aperture distance}
  ...
  \hl{Include a picture for instructions}
\end{frame}
...
\begin{frame}{Guess what happens?}
  ...
  \hl{Include an image to show how big of a hole}
\end{frame}
...
\begin{frame}{Guess what happens?}
  ...
  {\color{red} Some may observe "clearer" because of brightness}
\end{frame}
...
\begin{frame}{Guess what happens}
  ...
  \hl{Include a picture of how many holes}
\end{frame}
...
\begin{frame}{Introducing lens}
  ...
  \hl{Include a picture of holding lens (not the right one) with the pinhole camera}
\end{frame}
